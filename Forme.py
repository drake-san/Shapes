...
def DrawRectangle():
    randomColor = [random.randrange(
        255), random.randrange(255), random.randrange(255)]
    pygame.draw.rect(surface, randomColor, pygame.Rect(random.randrange(
        100), random.randrange(200), random.randrange(600), random.randrange(400)), width=3)
    flip()
...
def DrawLine():
    randomColor = [random.randrange(
        255), random.randrange(255), random.randrange(255)]
    randomValue = [random.randrange(600), random.randrange(400)]
    pygame.draw.line(surface, randomColor, randomValue, [
                     random.randrange(600), random.randrange(400)])
    flip()
